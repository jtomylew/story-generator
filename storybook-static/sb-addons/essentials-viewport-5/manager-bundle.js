try {
  (() => {
    ...
    var ye = (e, t, a) => (
      ...
      Se(
        t || !e || !e.__esModule
          ? Z(a, "default", { value: e, enumerable: !0 })
          : a,
        e,
      )
    );
    ...
    var X = ye(le()),
      ...
      Ae = { viewport: "reset", viewportRotated: !1 },
      Ee = globalThis.FEATURES?.viewportStoryGlobals ? Ce : Ae,
      pe = (e, t) => e.indexOf(t),
      Re = (e, t) => {
        let a = pe(e, t);
      ...
      _e = v.div({ display: "inline-flex", alignItems: "center" }),
      se = v.div(({ theme: e }) => ({
            ...
            : l.createElement(
                ...
                l.createElement(
                  W,
                  {
                    placement: "top",
                    tooltip: ({ onHide: I }) =>
                      l.createElement(q, { links: Ve(p, n, t, I) }),
                    closeOnOutsideClick: !0,
                    onVisibleChange: h,
                  },
                  l.createElement(
